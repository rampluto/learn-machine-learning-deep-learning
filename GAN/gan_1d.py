#examples of generating random samples
...
def generate_samples(n=100):
    """it is used to generate random samples"""
    X1 = rand(n)-0.5
    X2 = X1*X1
    X1 = X1.reshape(n,1)
    X2 = X2.reshape(n,1)
...
# model.summary()
# plot_model(model,to_file='discriminator1d.png',show_shapes=True, show_layer_names=True)
...
gan_model.summary()
plot_model(gan_model,to_file='gan_1d.png',show_shapes=True,show_layer_names=True)
